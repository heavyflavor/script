...
int myhadd(TString WorkPath,Int_t TESTMODE=1,TString SourceDir="out",TString DestinationDir="Hist",const Int_t Nfilesperjob=10)
{
  //bool	TESTMODE	= true;	// 
//*******************************************************************
...
//*******************************************************************
	...
	TString CMDcommand = Form("root4star -l -b -q myhadd.C\\\(\\\"$JOBID.root\\\",\\\"$FILELIST\\\",$INPUTFILECOUNT\\\)");
