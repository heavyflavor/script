...
//-----------------------------------------------------
void plots(TString input,int runnumber,char *InternalBusy="1002")
{
  TStopwatch SW;
  SW.Start();
  TH1::SetDefaultSumw2();
  ...
  //------------------------------------
  //Run argument 
  char *PowerSupply="2.6 V";
  char *Trigger="PedAdPhys_tcd_only";
  char *TriggerRate="100hz";
  char *Workdir="data02/DEV14/SST/offline_02_24/DeltaT";
  //------------------------------------
  TLatex   tx;
  ...
  //char *TriggerRate="100hz";
  //char *Workdir="data02/DEV14/SST/offline_02_24/DeltaT";
  tx.DrawLatex(0.1, 0.85,Form("File Name : %s",input.Data()));
  tx.DrawLatex(0.1, 0.75,Form("Trigger : %s",Trigger));
  tx.DrawLatex(0.1, 0.65,"Power supply: 2.6 V");
  //  tx.SetTextSize(0.05);
  tx.DrawLatex(0.1, 0.55,"Power setting: new 50 meter setting");
  tx.DrawLatex(0.1, 0.45,"Trigger Rate : 100 hz");
  tx.DrawLatex(0.1,0.35,Form("Internal Busy : %s",InternalBusy));
  tx.DrawLatex(0.1,0.25,Form("Work dir: %s",Workdir));
  tx.DrawLatex(0.1,0.15,"Wafer No.: 1");
  tx.DrawLatex(0.1,0.05,"Strip No.: 4");
  float ty1 = 0.58;
  float ty2 = 0.44;
  float dy  = 0.06;
  /*
